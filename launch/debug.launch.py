...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('midterm_robot_description'),
        'worlds',
        'empty_world.world'
    )
    ...
    pkg_gazebo = get_package_share_directory('midterm_robot_description')
    ...
    rviz_config_dir = PathJoinSubstitution(
        [FindPackageShare("midterm_robot_description"), "config", "rviz.rviz"]
    )
