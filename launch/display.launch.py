...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'midterm_robot_description.urdf'
    xacro_file = "midterm_robot_description.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "midterm_robot_description"
    use_urdf = False
    ...
    # Base Name or robot
    robot_base_name = "midterm_robot_description"
    ####### DATA INPUT END ##########
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("midterm_robot_description"), "rviz", "display_default.rviz"]
    )
    ...
    publish_robot_description = Node(
        package='midterm_robot_description',
